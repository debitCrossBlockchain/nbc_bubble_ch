...
{
    public partial class WaterImmersionTest : Form
    {
        int mStatFlagWI;
        static bool mStartTest = false;//为假修改，为真
        public static int[] mCurPT = new int[50];
        public static string Test_AreaWT = (0).ToString("X8");
        public static string Test_Filter_ConfigWT = (0).ToString("X4");
        public static string Test_Filter_numerWT = (0).ToString("X2");
        public static string Test_LIQUConsistenceWT = (0).ToString("X4");

        public static string HTest_Filter_ConfigWT = (0).ToString("X4");
        public static string HTest_Filter_numerWT = (0).ToString("X2");
        public static string HTest_LIQUConsistenceWT = (0).ToString("X4");
        public static string Test_LIQUWT = "";
        static int x = 0;
        /// <summary>
        /// 测试结果
        /// </summary>
        ...
        public static WaterImmersionTest MWaterImmersionTest = null;
        Main mTreeName = new Main();
        public WaterImmersionTest()
        {
            InitializeComponent();
        }
        /// <summary>
        /// 压力与时间曲线图
        /// </summary>
        private void WaterImmersionTestPTime(ZedGraphControl zgc)
        {
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "水浸入测试"))
                        {
                            labelWaterImmersionTestPress.Text = o.CurrentPress.ToString();
                            ...
                            if (textBoxTest_startp.Text.ToString() == "\0" || textBoxTest_startp.Text.ToString() == "")
                            {
                                ...
                                foreach (XmlNode node in xml.ChildNodes)
                                {
                                    if (node.Name == "Config")
                                    {
                                        ...
                                        {
                                            if (node1.Name == "WaterImmersionTest")
                                            {
        ...
        private void WaterImmersionTestFP(ZedGraphControl zgc)
        {
        ...
        private void WaterImmersionTest_Load(object sender, EventArgs e)
        {
            try
            {
                SunManage.DataBase.DataBase mDataBase = new DataBase.DataBase();
                mDataBase.CreatDB("WIStartTest");
                ...
                string mQuery = "Select [mStatFlagWI] From DeviceConcatenate where [DeviceName]='" + Main.MTreeName + "'";
                ...
                if (reader.Read())
                {
                    mStatFlagWI = Convert.ToInt32(reader[0].ToString());
                }
            ...
            WaterImmersionTestPTime(WaterImmersionTestZedGraphControlPTime);
            WaterImmersionTestFP(WaterImmersionTestZedGraphControlFP);
            this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestSet);//设置为当前的选项卡
                            ...
                            foreach (XmlNode node2 in node1.ChildNodes)
                            {
                                switch (node2.Name)
                                {
                                    ...
                                    case "Test_LIQUConsistence":
                                        HTest_LIQUConsistenceWT = node2.InnerText;
                                        break;
                                    case "Test_Filter_Config":
                                        HTest_Filter_ConfigWT = node2.InnerText;
                                        break;
                                    case "Test_Filter_number":
                                        HTest_Filter_numerWT = node2.InnerText;
                                        break;
                                    case "Test_LIQUName":
                                        Test_LIQUWT = node2.InnerText;
                                        break;
                                    default:
                                        break;
                                }
            ...
            this.timerWaterImmersionTest.Interval = 20000;
            this.timerWaterImmersionTest.Start();
             }
            catch (Exception ex)
            {
        ...
        /// <param name="e"></param>
        private void buttontabPageWaterImmersionTestSetTest_Click(object sender, EventArgs e)
        {
            CommPort mComPort = CommPort.Instance;
            ...
            try
            {
                try
                {
                    ...
                    if (mStartTest == true)
                    {
                        string mQuery = String.Format("INSERT INTO {0}([DeviceName],[Htest_type],[Test_Psernum],[Test_Tsernum],[Test_Fsernum],[Test_filt],[Test_LIQU],[HA_STime],[Test_LIQUType],[Test_LIQUConsistence],[Test_Filter_type],[Test_Filter_Config],[Test_Filter_number],[Test_Filter_Area],[Test_Meme_Aper],[Test_Velocity],[Test_Up_Volm],[Test_startp],[Test_SetBp],[Test_Dif_max]) VALUES ('" + mTreeName + "','" + "水浸入测试".ToString() + "','" + textBoxTest_Psernum.Text.ToString() + "','" + textBoxTest_Tsernum.Text.ToString() + "','" + textBoxTest_Fsernum.Text.ToString() + "','" + textBoxTest_filt.Text.ToString() + "','" + mLiqu.ToString() + "','" + DTime + "','" + textBoxTest_LIQU.Text.ToString() + "','" + HTest_LIQUConsistenceWT.ToString() + "','" + textBoxTest_Filter_Config.Text.ToString() + "','" + HTest_Filter_ConfigWT.ToString() + "','" + HTest_Filter_numerWT.ToString() + "','" + textBoxTest_Filter_Area.Text.ToString() + "','" + textBoxTest_Meme_Aper.Text.ToString() + "','" + textBoxTest_Velocity.Text.ToString() + "','" + textBoxTest_Up_Volm.Text.ToString() + "','" + textBoxTest_startp.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_Dif_max.Text.ToString() + "')", ("WIStartTest").ToString());
                    ...
                    if (mStartTest == false)
                    {
                        ...
                        string mQuery = "update [WIStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "水浸入测试".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + textBoxTest_LIQU.Text.ToString() + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceWT.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigWT.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + textBoxTest_Velocity.Text.ToString() + "',[Test_Up_Volm]='" + textBoxTest_Up_Volm.Text.ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_SetBp]='" + ("").ToString() + "',[Test_Dif_max]='" + textBoxTest_Dif_max.Text.ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
                ...
                mComPort.SearchDeviceAddress();
                string str = "FF" + "{0}" + "73" + "01" + Test_type + Test_Ps + Test_Ts + Test_Fs + Test_fi + Test_LI + MDataTime + mTest_LIQUType + Test_LIQUConsistenceWT + Test_Filter_ConfigWT + Test_Filter_numerWT + Test_AreaWT + Test_Meme_Aper + Test_Velocity + Test_Up_Volm + Test_start + Test_SetBp + Test_Dif_max + "00";
                str = string.Format(str, CommPort.mDeviceAddress.ToString("X2"));
                byte[] sendData = mComPort.convertstringtobyte(str);
                int sum = 0;
                foreach (int i in sendData)
            ...
            this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestState);//设置状态为当前的选项卡
        }

        private void buttonWaterImmersionTestLoad_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(mTreeName))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        HTest_Filter_ConfigWT = reader[11].ToString();
                        HTest_Filter_numerWT = reader[12].ToString();
                        HTest_LIQUConsistenceWT = reader[9].ToString();
                        textBoxTest_Dif_max.Text = reader[19].ToString();

                        if (string.IsNullOrEmpty(reader[11].ToString()))
                        {
                            Test_Filter_ConfigWT = (0).ToString("X4");
                        }
                        else
                        {
                            Test_Filter_ConfigWT = (Convert.ToInt64(reader[11].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[12].ToString()))
                        {
                            Test_Filter_numerWT = (0).ToString("X2");
                        }
                        else
                        {
                            Test_Filter_numerWT = (Convert.ToInt64(reader[12].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[9].ToString()))
                        {
                            Test_LIQUConsistenceWT = (0).ToString("X4");
                        }
                        else
                        {
                            Test_LIQUConsistenceWT = (Convert.ToInt64(reader[9].ToString())).ToString("X4");
                        }
        ...
        private void WaterImmersionTest_FormClosed(object sender, FormClosedEventArgs e)
        {
            MWaterImmersionTest = null;
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void timerWaterImmersionTest_Tick(object sender, EventArgs e)
        {
            this.WaterImmersionTestZedGraphControlPTime.GraphPane.CurveList.Clear();
            this.WaterImmersionTestZedGraphControlPTime.GraphPane.GraphObjList.Clear();

            WaterImmersionTestPTime(WaterImmersionTestZedGraphControlPTime);


            this.WaterImmersionTestZedGraphControlPTime.Refresh();
        }
        /// <summary>
        /// 保存水浸入测试结果到数据库
        /// </summary>
        ...
        {
            DialogResult dr = MessageBox.Show("你确定要保存水浸入测试结果吗?", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            string m1 = "";
            string m2 = "";
            string m3 = "";
            string m4 = "";
        ...
        private void pictureBoxPrint_Click(object sender, EventArgs e)
        {
            try
            {
                WaterImmersionTestPrinter mWaterImmersionTestPrinter = new WaterImmersionTestPrinter();
                mWaterImmersionTestPrinter.ShowDialog();
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestChart);//设置为当前的选项卡
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "保存水浸入测试结果");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "打印水浸入测试结果");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "查看水浸入测试曲线");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "桶式过滤器":
                        Test_Filter_ConfigWT = Barrel.Test_filter_Hight;
                        Test_Filter_numerWT = Barrel.Test_filter_Num;
                        break;
                    case "平板过滤器":
                        Test_Filter_ConfigWT = Plate.Test_Filter_Diameter;
        ...
        private void textBoxTest_Filter_Area_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Test_AreaWT = (Convert.ToInt64(((textBoxTest_Filter_Area.Text).Replace(".", "")))).ToString("X8");
                }
                else
                {
                    Test_AreaWT = (0).ToString("X8");
                }
        ...
        private void textBoxTest_LIQU_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                Test_LIQUConsistenceWT = Concentration.mTest_LIQUConsistence;
                if (textBoxTest_LIQU.Text == "其它")
                {
                    Test_LIQUWT = Fluid.Test_Filter_LiquidName;
                }
                else
                {
                    Test_LIQUWT = textBoxTest_LIQU.Text;
                }
            }
            catch (Exception ex)
            {
        ...
        private void pictureBoxstart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (mStatFlagWI == 1)
                {
                    ...
                    string mQuery = "update DeviceConcatenate set [mStatFlagWI]='" + (0).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'";
                ...
                else
                {
                    ...
                    string mQuery = "update DeviceConcatenate set [mStatFlagWI]='" + (1).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'"; ;
