...
{
    public partial class RateOfRise : Form
    {
        int mStatFlagRR;
        static bool mStartTest = false;//为假修改，为真
        public static int[] mCurPT = new int[50];
        public static string Test_AreaRR = (0).ToString("X8");
        public static string Test_Filter_ConfigRR = (0).ToString("X4");
        public static string Test_Filter_numerRR = (0).ToString("X2");
        public static string Test_LIQUConsistenceRR = (0).ToString("X4");

        public static string HTest_Filter_ConfigRR = (0).ToString("X4");
        public static string HTest_Filter_numerRR = (0).ToString("X2");
        public static string HTest_LIQUConsistenceRR = (0).ToString("X4");
        public static string Test_LIQURR = "";
        static int x = 0;
        /// <summary>
        /// 测试结果
        /// </summary>
        ...
        public  static Int32 Htest_DiffePress=0;
        ...
        public static RateOfRise MRateOfRise = null;
        ...
        /// 压力与时间曲线图
        /// </summary>
        private void RateOfRisePTime(ZedGraphControl zgc)
        {
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "保压测试"))
                        {
                            labelRateOfRisePress.Text = o.CurrentPress.ToString();
            ...
            foreach (CommPort oR in CommPort.MResult)
            {
                ...
                {
                    if (oR.CurrentType == "保压测试")
                    {
                        labelValue.Text = oR.Htest_DiffePress.ToString();
        ...
        private void RateOfRiseFP(ZedGraphControl zgc)
        {
            GraphPane myPane = zgc.GraphPane;
        ...
        private void RateOfRise_Load(object sender, EventArgs e)
        {

            try
            {
                SunManage.DataBase.DataBase mDataBase = new DataBase.DataBase();
                mDataBase.CreatDB("RRStartTest");
                ...
                string mQuery = "Select [mStatFlagRR] From DeviceConcatenate where [DeviceName]='" + Main.MTreeName + "'";
                ...
                if (reader.Read())
                {
                    mStatFlagRR = Convert.ToInt32(reader[0].ToString());
                }
                ...
                mConnection.Close();
                RateOfRisePTime(RateOfRiseZedGraphControlPTime);
                RateOfRiseFP(RateOfRiseZedGraphControlFP);
                if (mStatFlagRR == 1)
                {
                    //启动
                ...
                this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseSet);//设置为当前的选项卡
                                ...
                                foreach (XmlNode node2 in node1.ChildNodes)
                                {
                                    switch (node2.Name)
                                    {
                                        ...
                                        case "Test_LIQUConsistence":
                                            HTest_LIQUConsistenceRR = node2.InnerText;
                                            break;
                                        case "Test_Filter_Config":
                                            HTest_Filter_ConfigRR = node2.InnerText;
                                            break;
                                        case "Test_Filter_number":
                                            HTest_Filter_numerRR = node2.InnerText;
                                            break;
                                        case "Test_LIQUName":
                                            Test_LIQURR = node2.InnerText;
                                            break;
                                        default:
                                            break;
                                    }
                ...
                this.timerRateOfRise.Interval = 1000;
                this.timerRateOfRise.Start();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="e"></param>
        private void buttontabPageRateOfRiseSetTest_Click(object sender, EventArgs e)
        {
            CommPort mComPort = CommPort.Instance;

            string Test_type = (80).ToString("X2");
            ...
            try
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(mTreeName))
                    {
                        ...
                        string mSelectQuery = "Select * FROM [RRStartTest] Where [DeviceName]= '" + mTreeName.ToString() + "'";
                    ...
                    if (mStartTest == true)
                    {
                        string mQuery = String.Format("INSERT INTO {0}([DeviceName],[Htest_type],[Test_Psernum],[Test_Tsernum],[Test_Fsernum],[Test_filt],[Test_LIQU],[HA_STime],[Test_LIQUType],[Test_LIQUConsistence],[Test_Filter_type],[Test_Filter_Config],[Test_Filter_number],[Test_Filter_Area],[Test_Meme_Aper],[Test_Velocity],[Test_Up_Volm],[Test_startp],[Test_SetBp],[Test_Dif_max]) VALUES ('" + mTreeName + "','" + "保压测试".ToString() + "','" + textBoxTest_Psernum.Text.ToString() + "','" + textBoxTest_Tsernum.Text.ToString() + "','" + textBoxTest_Fsernum.Text.ToString() + "','" + textBoxTest_filt.Text.ToString() + "','" + mLiqu.ToString() + "','" + DTime + "','" + textBoxTest_LIQU.Text.ToString() + "','" + HTest_LIQUConsistenceRR.ToString() + "','" + textBoxTest_Filter_Config.Text.ToString() + "','" + HTest_Filter_ConfigRR.ToString() + "','" + HTest_Filter_numerRR.ToString() + "','" + textBoxTest_Filter_Area.Text.ToString() + "','" + textBoxTest_Meme_Aper.Text.ToString() + "','" + textBoxTest_Velocity.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_startp.Text.ToString() + "','" + ("").ToString() + "','" + ("").ToString() + "')", ("RRStartTest").ToString());
                    ...
                    if (mStartTest == false)
                    {
                        ...
                        string mQuery = "update [RRStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "保压测试".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + textBoxTest_LIQU.Text.ToString() + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceRR.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigRR.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + textBoxTest_Velocity.Text.ToString() + "',[Test_Up_Volm]='" + ("").ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_SetBp]='" + ("").ToString() + "',[Test_Dif_max]='" + ("").ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
                ...
                usbReferenceDevice theReferenceUsbDevice = new usbReferenceDevice(USB.vid, USB.pid);
                mComPort.SearchDeviceAddress();
                string str = "FF" + "{0}" + "73" + "01" + Test_type + Test_Ps + Test_Ts + Test_Fs + Test_fi + Test_LI + MDataTime + mTest_LIQUType + Test_LIQUConsistenceRR + Test_Filter_ConfigRR + Test_Filter_numerRR + Test_AreaRR + Test_Meme_Aper + Test_Velocity + Test_Up_Volm + Test_start + Test_SetBp + Test_Dif_max + "00";
                str = string.Format(str, CommPort.mDeviceAddress.ToString("X2"));
                byte[] sendData = mComPort.convertstringtobyte(str);
                int sum = 0;
                foreach (int i in sendData)
            ...
            this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseState);//设置状态为当前的选项卡
        }

        private void buttonRateOfRiseLoad_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(mTreeName))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        HTest_Filter_ConfigRR = reader[11].ToString();
                        HTest_Filter_numerRR = reader[12].ToString();
                        HTest_LIQUConsistenceRR = reader[9].ToString();
                        //textBoxTest_Dif_max.Text = reader[19].ToString();

                        if (string.IsNullOrEmpty(reader[11].ToString()))
                        {
                            Test_Filter_ConfigRR = (0).ToString("X4");
                        }
                        else
                        {
                            Test_Filter_ConfigRR = (Convert.ToInt64(reader[11].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[12].ToString()))
                        {
                            Test_Filter_numerRR = (0).ToString("X2");
                        }
                        else
                        {
                            Test_Filter_numerRR = (Convert.ToInt64(reader[12].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[9].ToString()))
                        {
                            Test_LIQUConsistenceRR = (0).ToString("X4");
                        }
                        else
                        {
                            Test_LIQUConsistenceRR = (Convert.ToInt64(reader[9].ToString())).ToString("X4");
                        }
        ...
        private void RateOfRise_FormClosed(object sender, FormClosedEventArgs e)
        {
            MRateOfRise = null;
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void timerRateOfRise_Tick(object sender, EventArgs e)
        {
            this.RateOfRiseZedGraphControlPTime.GraphPane.CurveList.Clear();
            this.RateOfRiseZedGraphControlPTime.GraphPane.GraphObjList.Clear();

            RateOfRisePTime(RateOfRiseZedGraphControlPTime);


            this.RateOfRiseZedGraphControlPTime.Refresh();
        }
        /// <summary>
        /// 打印保压测试结果
        /// </summary>
        ...
        private void pictureBoxPrint_Click(object sender, EventArgs e)
        {
            try
            {
                RateOfRisePrinter mRateOfRisePrinter = new RateOfRisePrinter();
                mRateOfRisePrinter.ShowDialog();
            }
            catch(Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        {
            DialogResult dr = MessageBox.Show("你确定要保存扩散流测试结果吗?", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            string m1 = "";
            string m2 = "";
            string m3 = "";
            string m4 = "";
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseChart);//设置为当前的选项卡
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "保存保压测试结果");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "打印保压测试结果");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "查看保压测试曲线");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "桶式过滤器":
                        Test_Filter_ConfigRR = Barrel.Test_filter_Hight;
                        Test_Filter_numerRR = Barrel.Test_filter_Num;
                        break;
                    case "平板过滤器":
                        Test_Filter_ConfigRR = Plate.Test_Filter_Diameter;
        ...
        private void textBoxTest_Filter_Area_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Test_AreaRR = (Convert.ToInt64(((textBoxTest_Filter_Area.Text).Replace(".", "")))).ToString("X8");
                }
                else
                {
                    Test_AreaRR = (0).ToString("X8");
                }
        ...
        private void textBoxTest_LIQU_TextChanged(object sender, EventArgs e)
        {
            try
            {
                Test_LIQUConsistenceRR = Concentration.mTest_LIQUConsistence;
                if (textBoxTest_LIQU.Text == "其它")
                {
                    Test_LIQURR = Fluid.Test_Filter_LiquidName;
                }
                else
                {
                    Test_LIQURR = textBoxTest_LIQU.Text;
                }
            }
            catch (Exception ex)
            {
        ...
        private void pictureBoxstart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (mStatFlagRR == 1)
                {
                    ...
                    string mQuery = "update DeviceConcatenate set [mStatFlagRR]='" + (0).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'";
                ...
                else
                {
                    ...
                    string mQuery = "update DeviceConcatenate set [mStatFlagRR]='" + (1).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'"; ;
