...
{
    public partial class Barrel : Form
    {
       ...
       static Double mAr;
        ...
        /// <param name="e"></param>
        private void Barrel_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                formPoint = new Point();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Barrel_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                if (formMove == true)
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Barrel_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
