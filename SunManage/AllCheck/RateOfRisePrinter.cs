...
{
    public partial class RateOfRisePrinter : Form
    {
        ...
        public RateOfRisePrinter()
        {
            InitializeComponent();
        }

        private void RateOfRisePrinter_Load(object sender, EventArgs e)
        {
            try
            {
                this.reportViewer.Reset();
                this.reportViewer.LocalReport.ReportEmbeddedResource = "SunManage.AllCheck.ReportRORPT.rdlc";
                reportViewer.LocalReport.DataSources.Clear();
                reportViewer.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSetRORReport", GetDataSet()));
                reportViewer.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSetRORPTReport", ds()));
            ...
            if (!string.IsNullOrEmpty(mTreeName))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        dr["Htest_DiffePress"] = RateOfRise.Htest_DiffePress;
                        dr["Test_Result"] = RateOfRise.Htest_ALL_Result;
                        dr["Test_Name"] = RateOfRise.Htest_Name;
        ...
        private void RateOfRisePrinter_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
