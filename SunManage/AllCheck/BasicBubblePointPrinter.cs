...
{
    public partial class BasicBubblePointPrinter : Form
    {
        ...
        public BasicBubblePointPrinter()
        {
            InitializeComponent();
        }

        private void BasicBubblePointPrinter_Load(object sender, EventArgs e)
        {
            //HistoricalRecords mHistoricalRecords = new HistoricalRecords();

            this.reportViewer.Reset();
            this.reportViewer.LocalReport.ReportEmbeddedResource = "SunManage.AllCheck.ReportBBPPT.rdlc";
            reportViewer.LocalReport.DataSources.Clear();
            reportViewer.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSetBBPReport", GetDataSet()));

            reportViewer.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSetBBPPTReport", ds()));
            ...
            if (!string.IsNullOrEmpty(mTreeName))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        dr["Test_Value"] = BasicBubblePoint.Htest_TestValue.ToString();
                        dr["Test_Result"] = BasicBubblePoint.Htest_ALL_Result;
                        dr["Test_Name"] = BasicBubblePoint.Htest_Name;
             ...
             int i = 0;
                 ...
                 foreach (CommPort o in CommPort.MCurrent)
                 {
                     ...
                     if (o.DeviceID == CommPort.mDeviceAddress)
                     {
                         ...
                         {
                             if (o.CurrentPress.ToString() == "\0" || o.CurrentPress.ToString() == "")
                             {
                                 //
                             ...
                             {
                                                                  //
                                 dr["DataPressure"] =Convert.ToInt32( o.CurrentPress.ToString());
                                 dr["DataTime"] = i;
        ...
        private void BasicBubblePointPrinter_FormClosed(object sender, FormClosedEventArgs e)
        {
