...
namespace SunManage.AllCheck
{
    public partial class ManualBubblePoint : Form
    {
        ...
        private void BasicBubblePointPTime(ZedGraphControl zgc)
        {
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "手动泡点测试"))
                        {
        ...
        private void ManualBubblePoint_Load(object sender, EventArgs e)
        {
            ...
            this.tabControlManualBubblePoint.SelectTab(tabPageManualBubblePointSet);//设置为当前的选项卡
            ...
            if (!string.IsNullOrEmpty(textBoxTest_Velocity.Text))
           {
            ...
            try
            {
                try
                {
                    ...
                    if (mStartTest == true)
                    {
                        string mQuery = String.Format("INSERT INTO {0}([DeviceName],[Htest_type],[Test_Psernum],[Test_Tsernum],[Test_Fsernum],[Test_filt],[Test_LIQU],[HA_STime],[Test_LIQUType],[Test_LIQUConsistence],[Test_Filter_type],[Test_Filter_Config],[Test_Filter_number],[Test_Filter_Area],[Test_Meme_Aper],[Test_Velocity],[Test_Up_Volm],[Test_startp],[Test_SetBp],[Test_Dif_max]) VALUES ('" + mTreeName + "','" + "手动泡点测试".ToString() + "','" + textBoxTest_Psernum.Text.ToString() + "','" + textBoxTest_Tsernum.Text.ToString() + "','" + textBoxTest_Fsernum.Text.ToString() + "','" + textBoxTest_filt.Text.ToString() + "','" + mLiqu.ToString() + "','" + DTime + "','" + textBoxTest_LIQU.Text.ToString() + "','" + HTest_LIQUConsistenceMP.ToString() + "','" + textBoxTest_Filter_Config.Text.ToString() + "','" + HTest_Filter_ConfigMP.ToString() + "','" + HTest_Filter_numerMP.ToString() + "','" + textBoxTest_Filter_Area.Text.ToString() + "','" + textBoxTest_Meme_Aper.Text.ToString() + "','" + textBoxTest_Velocity.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_startp.Text.ToString() + "','" + textBoxTest_SetBp.Text.ToString() + "','" + ("").ToString() + "')", ("MBStartTest").ToString());
            ...
            this.tabControlManualBubblePoint.SelectTab(tabPageManualBubblePointState);//设置状态选项为当前的选项卡
        }
        ...
        {
            DialogResult dr = MessageBox.Show("你确定要保存手动泡点测试结果吗?", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlManualBubblePoint.SelectTab(tabPageManualBubblePointChart);//设置为当前的选项卡
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "保存手动泡点测试结果");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "打印手动泡点测试结果");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "查看手动泡点测试曲线");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "桶式过滤器":
                        Test_Filter_ConfigMP = Barrel.Test_filter_Hight;
                        Test_Filter_numerMP = Barrel.Test_filter_Num;
                        break;
                    case "平板过滤器":
