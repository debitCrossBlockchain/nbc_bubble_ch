...
using System.IO;
using SunManage.DataBase;
namespace SunManage.AllCheck
{
    public partial class BasicBubblePoint : Form
    {
        int mStatFlag ;
        static bool mStartTest = false;//为假修改，为真
        public static int [] mCurPT = new int [50];
      
        public static string Test_AreaBP = (0).ToString("X8");
        public static string Test_Filter_ConfigBP = "0000";
        public static string Test_Filter_numerBP = "00";
        public static string Test_LIQUConsistenceBP = (0).ToString("X4");
    
        public static string HTest_Filter_ConfigBP = "";
        public static string HTest_Filter_numerBP = "";
        public static string HTest_LIQUConsistenceBP = "";
        public static string Test_LIQUBP = "";
       static int x = 0;
        /// <summary>
        /// 测试结果
        /// </summary>
        static string Test_type="基本泡点测试";
        ...
        public static BasicBubblePoint BacicBubble = null;

        //mComPort.SearchDeviceAddress();

        public BasicBubblePoint()
        {
            InitializeComponent();
        ...
        private void BasicBubblePointPTime(ZedGraphControl zgc)
        {
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "基本泡点测试"))
                        {
                            labelBasicBubblePointPress.Text = o.CurrentPress.ToString();
                            ...
                            if (textBoxTest_startp.Text.ToString() == "\0" || textBoxTest_startp.Text.ToString() == "")
                            {
                                ...
                                foreach (XmlNode node in xml.ChildNodes)
                                {
                                    if (node.Name == "Config")
                                    {
                                        ...
                                        {
                                            if (node1.Name == "BasicBubblePoint")
                                            {
        ...
        private void BasicBubblePoint_Load(object sender, EventArgs e)
        {
            try
            {
                SunManage.DataBase.DataBase mDataBase = new DataBase.DataBase();
                mDataBase.CreatDB("BBStartTest");
                ...
                string mQuery = "Select [mStatFlagBP] From DeviceConcatenate where [DeviceName]='" + Main.MTreeName + "'";
                ...
                if (reader.Read())
                {
                    mStatFlag =Convert.ToInt32( reader[0].ToString());
                }
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabPageBasicBubblePointSet);//设置为当前的选项卡
                                ...
                                foreach (XmlNode node2 in node1.ChildNodes)
                                {
                                    switch (node2.Name)
                                    {
                                        ...
                                        case "Test_Velocity":
                                            ...
                                            {
                                                case "标准测试":
                                                    checkBoxTest_VelocityS.Checked = true;
                                                    break;
                                                case "快速测试":
                                                    checkBoxTest_VelocityF.Checked = true;
                                                    break;
                                                default:
                                                    break;
                                            }
                                        ...
                                        case "Test_LIQUConsistence":
                                            HTest_LIQUConsistenceBP = node2.InnerText;
                                            break;
                                        case "Test_Filter_Config":
                                            HTest_Filter_ConfigBP = node2.InnerText;
                                            break;
                                        case "Test_Filter_number":
                                             HTest_Filter_numerBP = node2.InnerText;
                                            break;
                                        case "Test_LIQUName":
                                           Test_LIQUBP = node2.InnerText;
                                            break;
                ...
                BasicBubblePointPTime(BasicBubbleZedGraphControlPTime);
                BasicBubblePointFP(BasicBubbleZedGraphControlFP);
                this.timerBasicBubblePoint.Start();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="e"></param>
        private void buttontabPageBasicBubblePointSetTest_Click(object sender, EventArgs e)
        {
            ...
            //Test_Filter_ConfigBP = "0000";
            //   Test_Filter_numerBP = "00";
            ...
            //string Test_Velocity = (69).ToString("X4");
            //string mTVelocity = "";
            //if (checkBoxTest_VelocityS.Checked == true)
            //{
            //    mTVelocity = "标准测试";
            //}
            //if (checkBoxTest_VelocityF.Checked == true)
            //{
            //    mTVelocity = "快速测试";
            //}
            //switch (mTVelocity)
            ...
            //            string mQuery = "update [BBStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "基本泡点测试".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + textBoxTest_LIQU.Text.ToString() + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceBP.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigBP.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + mTVelocity.ToString() + "',[Test_Up_Volm]='" + ("").ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_SetBp]='" + textBoxTest_SetBp.Text.ToString() + "',[Test_Dif_max]='" + ("").ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
            ...
            //    mComPort.SearchDeviceAddress();
            //    string str = "FF" + "{0}" + "70" + "01" + Test_type + Test_Ps + Test_Ts + Test_Fs + Test_fi + Test_LI + MDataTime + mTest_LIQUType + Test_LIQUConsistenceBP + Test_Filter_type + Test_Filter_ConfigBP + Test_Filter_numerBP + Test_AreaBP + Test_Meme_Aper + Test_Velocity + Test_Up_Volm + Test_start + Test_SetBp + Test_Dif_max + "00";
            //    str = string.Format(str, CommPort.mDeviceAddress.ToString("X2"));
            //    byte[] sendData = mComPort.convertstringtobyte(str);
            //    int sum = 0;     
            //    foreach (int i in sendData)
            ...
            try
            {
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabPageBasicBubblePointState);//设置状态为当前的选项卡
            }
            catch (Exception er)
            {
                MessageBox.Show(er.Message);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void buttonBasicBubblePointLoad_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(mTreeName))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                       ...
                       HTest_Filter_ConfigBP = reader[11].ToString();
                       HTest_Filter_numerBP = reader[12].ToString();
                       HTest_LIQUConsistenceBP = reader[9].ToString();

                        if(string.IsNullOrEmpty(reader[11].ToString()))
                        {
                       Test_Filter_ConfigBP = (0).ToString("X4");
                        }
                        else
                        {
                            Test_Filter_ConfigBP = (Convert.ToInt64(reader[11].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[12].ToString()))
                        {
                            Test_Filter_numerBP = (0).ToString("X2");
                        }
                        else
                        {
                            Test_Filter_numerBP = (Convert.ToInt64(reader[12].ToString())).ToString("X4");
                        }
                        if (string.IsNullOrEmpty(reader[9].ToString()))
                        {
                            Test_LIQUConsistenceBP = (0).ToString("X4");
                        }
                        else
                        {
                            Test_LIQUConsistenceBP = (Convert.ToInt64(reader[9].ToString())).ToString("X4");
                        }
        ...
        private void BasicBubblePoint_FormClosed(object sender, FormClosedEventArgs e)
        {

            BacicBubble =null;
            BasicBubblePoint mBasicBubblePoint = new BasicBubblePoint();
            if (!(mBasicBubblePoint.IsDisposed))
            {
               this.Dispose();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void timerBasicBubblePoint_Tick(object sender, EventArgs e)
        {
            this.BasicBubbleZedGraphControlPTime.GraphPane.CurveList.Clear();
            this.BasicBubbleZedGraphControlPTime.GraphPane.GraphObjList.Clear();

            BasicBubblePointPTime(BasicBubbleZedGraphControlPTime);


            this.BasicBubbleZedGraphControlPTime.Refresh();
        ...
        {
            DialogResult dr = MessageBox.Show("你确定要保存基本泡点测试结果吗?", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void pictureBoxPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BasicBubblePointPrinter mBasicBubblePointPrinter = new BasicBubblePointPrinter();
                mBasicBubblePointPrinter.ShowDialog();
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabControlBasicBubblePointChart);//设置为当前的选项卡
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            ...
            p.ShowAlways = true;
            p.SetToolTip(this.pictureBoxSave, "保存基本泡点测试结果");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "打印基本泡点测试结果");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "查看基本泡点测试曲线");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void checkBoxTest_VelocityS_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (checkBoxTest_VelocityS.Checked == true)
                {
                    checkBoxTest_VelocityF.Checked = false;
                }
                else
                {
                    checkBoxTest_VelocityF.Checked = true;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void checkBoxTest_VelocityF_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (checkBoxTest_VelocityF.Checked == true)
                {
                    checkBoxTest_VelocityS.Checked = false;
                }
                else
                {
                    checkBoxTest_VelocityS.Checked = true;
        ...
        private void textBoxTest_Filter_Area_TextChanged(object sender, EventArgs e)
        {
             try
            {
                ...
                {
                    Test_AreaBP = (Convert.ToInt64(((textBoxTest_Filter_Area.Text).Replace(".", "")))).ToString("X8");
                }
                else
                {
                    Test_AreaBP = (0).ToString("X8");
                }
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "桶式过滤器":
                        Test_Filter_ConfigBP = Barrel.Test_filter_Hight;
                        Test_Filter_numerBP = Barrel.Test_filter_Num;
                        break;
                    case "平板过滤器":
                        Test_Filter_ConfigBP = Plate.Test_Filter_Diameter;
        ...
        { 
            ...
            if (mStatFlag == 1)
            {
                ...
                string mQuerySt = "update DeviceConcatenate set [mStatFlagBP]='" + (0).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'";
                  

                    mConnection = new OleDbConnection(sAccessConnection);

                    OleDbCommand daSt = new OleDbCommand(mQuerySt, mConnection);


                    mConnection.Open();
                    daSt.ExecuteNonQuery();
            ...
            else
            {
                ...
                string mQuery = "update DeviceConcatenate set [mStatFlagBP]='" + (1).ToString() + "' where [DeviceName]='" + (Main.MTreeName).ToString() + "'"; ;
        ...
        private void textBoxTest_LIQU_TextChanged(object sender, EventArgs e)
        {
            try
            {
                Test_LIQUConsistenceBP = Concentration.mTest_LIQUConsistence;
                if (textBoxTest_LIQU.Text == "其它")
                {
                    Test_LIQUBP = Fluid.Test_Filter_LiquidName;
                }
                else
                {
                    Test_LIQUBP = textBoxTest_LIQU.Text;
                }
            }
            catch (Exception ex)
            {
