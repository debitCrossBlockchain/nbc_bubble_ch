...
namespace SunManage.AllCheck
{
    public partial class HistoricalRecords : Form
    {
        ...
        private void buttonSearchALLHis_Click(object sender, EventArgs e)
        {
            ...
            string mQuery = "Select TestHisData as 序号,Test_Psernum as 生产批号,Test_Fsernum as 产品名称,HA_STime as 测试时间,Htest_type as 测试类型 From {0} ORDER BY TestHisData";
        ...
        private void btHTime_Click(object sender, EventArgs e)
        {
            ...
            string mQuery = "Select TestHisData as 序号,Test_Psernum as 生产批号,Test_Fsernum as 产品名称,HA_STime as 测试时间,Htest_type as 测试类型 From {0}" + "  where [HA_STime] like'" + " " + DTime + " %%:%%" + "'" + " ORDER BY TestHisData";
            //+DTime+" "+"%%:%%"+ 
