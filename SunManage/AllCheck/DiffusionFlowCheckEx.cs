...
{
    public partial class DiffusionFlowCheckEx : Form
    {
        int mStatFlagDF;
        ...
        private void DiffusionFlowCheckPTime(ZedGraphControl zgc)
        {
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "扩散流测试"))
                        {
        ...
        private void DiffusionFlowCheck_Load(object sender, EventArgs e)
        {
            ...
            this.tabControlDiffusionFlowCheck.SelectTab(tabPageDiffusionFlowCheckSet);//设置为当前的选项卡
        ...
        private void buttontabPageDiffusionFlowCheckSetTest_Click(object sender, EventArgs e)
        {
            ...
            //        if (mStartTest == true)
            //        {
            //            string mQuery = String.Format("INSERT INTO {0}([DeviceName],[Htest_type],[Test_Psernum],[Test_Tsernum],[Test_Fsernum],[Test_filt],[Test_LIQU],[HA_STime],[Test_LIQUType],[Test_LIQUConsistence],[Test_Filter_type],[Test_Filter_Config],[Test_Filter_number],[Test_Filter_Area],[Test_Meme_Aper],[Test_Velocity],[Test_Up_Volm],[Test_startp],[Test_SetBp],[Test_Dif_max]) VALUES ('" + mTreeName + "','" + "水浸入测试".ToString() + "','" + textBoxTest_Psernum.Text.ToString() + "','" + textBoxTest_Tsernum.Text.ToString() + "','" + textBoxTest_Fsernum.Text.ToString() + "','" + textBoxTest_filt.Text.ToString() + "','" + mLiqu.ToString() + "','" + DTime + "','" + textBoxTest_LIQU.Text.ToString() + "','" + HTest_LIQUConsistenceDF.ToString() + "','" + textBoxTest_Filter_Config.Text.ToString() + "','" + HTest_Filter_ConfigDF.ToString() + "','" + HTest_Filter_numerDF.ToString() + "','" + textBoxTest_Filter_Area.Text.ToString() + "','" + textBoxTest_Meme_Aper.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_Up_Volm.Text.ToString() + "','" + textBoxTest_startp.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_Dif_max.Text.ToString() + "')", ("DFStartTest").ToString());
            ...
            //            string mQuery = "update [DFStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "扩散流测试".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + textBoxTest_LIQU.Text.ToString() + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceDF.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigDF.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + ("").ToString() + "',[Test_Up_Volm]='" + textBoxTest_Up_Volm.Text.ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_SetBp]='" + ("").ToString() + "',[Test_Dif_max]='" + textBoxTest_Dif_max.Text.ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
            ...
            //    MessageBox.Show(er.Message);
            //}
            this.tabControlDiffusionFlowCheck.SelectTab(tabPageDiffusionFlowCheckState);//设置状态选项为当前的选项卡
        }
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlDiffusionFlowCheck.SelectTab(tabPageDiffusionFlowCheckChart);//设置为当前的选项卡
            }
            catch (Exception ex)
            {
                LogClass.WriteLogFile ("Exception:" + ex.ToString());
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "保存扩散流测试结果");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "打印扩散流测试结果");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "查看扩散流测试曲线");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "桶式过滤器":
                        Test_Filter_ConfigDF = Barrel.Test_filter_Hight;
                        Test_Filter_numerDF = Barrel.Test_filter_Num;
                        break;
                    case "平板过滤器":
